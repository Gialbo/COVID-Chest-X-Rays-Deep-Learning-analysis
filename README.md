...
Final project for the course "Bioinformatics", A.Y. 2020/2021. [`Presentation`](https://github.com/Gialbo/COVID-Chest-X-Rays-Deep-Learning-analysis/blob/main/slides.pdf) 

Instructions to run the code can be found [`here`](./experiments).
# Table of Contents
1. [Data](#data)
2. [Models](#models)
